...
namespace Student_Enrolment_System.Controllers
{
    interface IFormController
    {
        ...
        ///  (<paramref name="Birthday"/>).</summary>
        ...
        ///<summary>This is for get all students registration numbers</summary>
        List<Int32> GetRegistraionNumbers();

        ///<summary>This is for insert course fee details related to students
        /// (<paramref name="CourseFee_object"/> )</summary>
        bool InsertCourseFee(CourseFee Fee);
    }
}
